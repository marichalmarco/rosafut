...
// Database connection
mongoose.connect("mongodb+srv://mmarichal:tufsaro2025@clusterdev.ynvq74n.mongodb.net/rosafut?retryWrites=true&w=majority&appName=Clusterdev", {
...
// Home - list all players
app.get("/rosafut",  (req, res) => {
